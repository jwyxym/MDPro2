...
public class AnimationControl : MonoBehaviour
{
    ...
    public static void PlayAnimation(Transform animationContainer, string animationName, bool forced = false)
    {
        ...
        //Mat_022 控制
        if (animationName == "DamagePhase1ToPhase2" && animationContainer.name.StartsWith("Mat_022_near"))
        {
            animationContainer.Find("Eff_toPhase2_near").gameObject.SetActive(true);
        }
        if (animationName == "DamagePhase1ToPhase2" && animationContainer.name.StartsWith("Mat_022_far"))
        {
            animationContainer.Find("Eff_toPhase2_far").gameObject.SetActive(true);
        }
        if (animationName == "DamagePhase2ToPhase3" && animationContainer.name.StartsWith("Mat_022_near"))
        {
            animationContainer.Find("Eff_toPhase3_near").gameObject.SetActive(true);
        }
        if (animationName == "DamagePhase2ToPhase3" && animationContainer.name.StartsWith("Mat_022_far"))
        {
            animationContainer.Find("Eff_toPhase3_far").gameObject.SetActive(true);
        }
        if (animationName == "DamagePhase3ToPhase4" && animationContainer.name.StartsWith("Mat_022_near"))
        {
            animationContainer.Find("Eff_toPhase4_near").gameObject.SetActive(true);
        }
        if (animationName == "DamagePhase3ToPhase4" && animationContainer.name.StartsWith("Mat_022_far"))
        {
            animationContainer.Find("Eff_toPhase4_far").gameObject.SetActive(true);
        }
        if (animationName == "DamagePhase4ToEnd" && animationContainer.name.StartsWith("Mat_022_near"))
        {
            animationContainer.Find("Eff_toEnd_near").gameObject.SetActive(true);
        }
        if (animationName == "DamagePhase4ToEnd" && animationContainer.name.StartsWith("Mat_022_far"))
        {
            animationContainer.Find("Eff_toEnd_far").gameObject.SetActive(true);
        }
    }    
    ...
    public static void PlayFieldSE(Transform target, string song)
    {
        ...
        if (target == LoadAssets.field1_) UIHelper.playSound(seFull + "_P", 1f);
        if (target == LoadAssets.field2_) UIHelper.playSound(seFull + "_R", 1f);
    }
}
