...
public class ABLoader : MonoBehaviour
{
    ...
    public static GameObject LoadABFromFile(string path, Transform father = null)
    {
        var ab = AssetBundle.LoadFromFile(Boot.root + "assetbundle/" + path);
    ...
    /// <returns></returns>
    public static GameObject LoadABFromFolder(string path, string abname = "NewABs")
    {
        List<AssetBundle> bundles = new List<AssetBundle>();
        GameObject gos = new GameObject(abname);
        DirectoryInfo direction = new DirectoryInfo(Boot.root + "assetbundle/" + path);
