...
public class CardOnSelection : MonoBehaviour
{
    ...
    public CardOnSelection(gameCard card, bool theFirst, bool theLast, bool sort)
    {
        ...
        icon_selected = go.transform.GetChild(7).gameObject;
        selectable = true;

        icon_order = go.transform.GetChild(8).gameObject;
        num_order = go.transform.GetChild(8).GetChild(0).GetComponent<UILabel>();
