...
public class LoadSFX : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        hl_set = ABLoader.LoadAB("effects/hitghlight/fxp_hl_set_001", SFXContainer);
        hl_set_sct = ABLoader.LoadAB("effects/hitghlight/fxp_hl_set_sct_001", SFXContainer);
        hl_spsom = ABLoader.LoadAB("effects/hitghlight/fxp_hl_spsom_001", SFXContainer);
        hl_spsom_sct = ABLoader.LoadAB("effects/hitghlight/fxp_hl_spsom_sct_001", SFXContainer  );
    ...
    public static GameObject Decoration(string path, bool singleFile, Transform parent, string name = default)
    {
        ...
        if (singleFile)
            ...
            decoration = ABLoader.LoadABFolder(path, name);
    ...
    IEnumerator DelayMaterialShow(float time, bool hasCutin, float time_move, gameCard gameCard)
    {
        ...
        switch (type)
        {
            case "FUSION":
                ...
                {
                    ms = ABLoader.LoadABFolder("timeline/summon/summonfusion/summonfusionshowunitcard08");
                }
                else
                    ms = ABLoader.LoadABFolder("timeline/summon/summonfusion/summonfusionshowunitcard0" + materials.Count);
                break;
            case "LINK":
                if (materials.Count > 8)
                {
            ...
            case "RITUAL":
                ...
                {
                    ms = ABLoader.LoadABFolder("timeline/summon/summonritual/summonritualshowunitcard06");
                }
                else
                    ms = ABLoader.LoadABFolder("timeline/summon/summonritual/summonritualshowunitcard0" + materials.Count);
                break;
            default:
                ms = ABLoader.LoadABFolder("timeline/summon/summonxyz/summonxyzshowunitcard0" + materials.Count);
                break;
        }
    ...
    {
        var go = ABLoader.LoadAB("timeline\\summon\\summonlink\\summonlink01_01");
        ...
        var go2 = ABLoader.LoadABFolder("timeline\\summon\\summonritual\\summonritual01");
    ...
    {
        var go = ABLoader.LoadAB("timeline\\summon\\summonlink\\summonlink02_01");
        GameObject front1 = go;
        GameObject back1 = go;
        GameObject side1 = go;
        GameObject post = go;
    ...
    {
        var go = ABLoader.LoadAB("timeline\\summon\\summonlink\\summonlink03_01");
        GameObject front1 = go;
        GameObject back1 = go;
        GameObject side1 = go;
        GameObject post = go;
    ...
    {
        var go = ABLoader.LoadAB("timeline\\summon\\summonsynchro\\summonsynchro01");
    ...
    {
        var go = ABLoader.LoadAB("timeline\\summon\\summonxyz\\summonxyz03_01");
