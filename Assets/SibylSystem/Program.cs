...
public class Program : MonoBehaviour
{
    ...
    public DeckManagerMono deckManagerMono;
    ...
    public UILabel hint;
    public DuelComment duelCommentMe;
    public DuelComment duelCommentOp;
    public DeckDecoration deckDecoration;
    public SearchFilter searchFliter;
    ...
    public GameObject new_ui_deckOnSearchList;
    public GameObject new_ui_cardOnBook;
    ...
    public GameObject ES_2_left;
    public GameObject ES_2_right;
    public GameObject ES_2Force_left;
    ...
    public GameObject cards_count_left;
    public GameObject cards_count_right;

    public GameObject ai;
    public GameObject astral;
    public GameObject blueangel;
    public GameObject geese;
    public GameObject gongenzaka;
    public GameObject yuzu;
    public GameObject yusei;
    public GameObject haga;
    public GameObject aki;
    public GameObject jack;
    public GameObject jyonochi;
    public GameObject kaiba;
    public GameObject kiryu;
    public GameObject mai;
    public GameObject manjyome;
    public GameObject syo;
    public GameObject playmaker;
    public GameObject revolver;
    public GameObject rua;
    public GameObject ryoga;
    public GameObject yuya;
    public GameObject sawatari;
    public GameObject kaito;
    public GameObject asuka;
    public GameObject yuma;
    public GameObject yugi;
    public GameObject judai;
    public GameObject four;
    public GameObject guide;

    [Header("Sprite")]
    public Sprite buttonFrameGreen;
    public Sprite buttonFrameRed;
    public Sprite buttonFrameGreenHover;
    public Sprite buttonFrameRedHover;

    public Sprite buttonToggleL;
    public Sprite buttonToggleL_Over;
    public Sprite buttonToggleL_On;
    public Sprite buttonToggleM;
    public Sprite buttonToggleM_Over;
    public Sprite buttonToggleM_On;
    public Sprite buttonToggleM_CheckOn;
    public Sprite buttonToggleM_CheckOff;
    public Sprite buttonToggleS;
    public Sprite buttonToggleS_Over;
    public Sprite buttonToggleS_On;
    #endregion
    ...
    private void initialize()
    {
        ...
        if (aspect > 16)
        {
            main_camera.fieldOfView = 30 + 16 - aspect;
        }
    }
    ...
    public static GameObject coveredGameObject;

    public static Collider coveredCollider;

    public static GameObject eventGameObject;

    public static Collider eventCollider;
    ...
    {
        //if (Shortcuts.lockCamera) cameraPosition = new Vector3(0, 95, -37);
    ...
    )
    {
        ...
        {
            if(return_value.name == "mod_cardmanager_card(Clone)")
                return_value.layer = 16;
            else
    ...
    public NewDeckManager newDeckManager;
    ...
    private void initializeALLservants()
    {
        ...
        newDeckManager = new NewDeckManager();
        servants.Add(newDeckManager);
        ocgcore = new Ocgcore();
    ...
    public void shiftToServant(Servant to)
    {
        ...
        if (to != newDeckManager && newDeckManager.isShowed) newDeckManager.hide();
        ...
        if (to == newDeckManager && newDeckManager.isShowed == false) newDeckManager.show();
    ...
    private void Awake()
    {
        if (Screen.width < 200 || Screen.height < 200) Screen.SetResolution(1366, 768, false);
    ...
    private void Update()
    {
        ...
        if (hoverobject != null)
            if (hoverobject.layer == 11 || hoverobject.layer == 7 || hoverobject.layer == 8 || pointedGameObject == null)
            {
                pointedGameObject = hoverobject;
                pointedCollider = UICamera.lastHit.collider;
                if(UICamera.coveredHit.collider != null)
                {
                    coveredCollider = UICamera.coveredHit.collider;
                    coveredGameObject = UICamera.coveredHit.collider.gameObject;
                }
                else
                {
                    coveredCollider = null;
                    coveredGameObject = null;
                }
                if (UICamera.eventHit.collider != null)
                {
                    eventCollider = UICamera.eventHit.collider;
                    eventGameObject = UICamera.eventHit.collider.gameObject;
                }
                else
                {
                    coveredCollider = null;
        ...
        if(GameTextureManager.loadedPicture.Count > 200)
            GameTextureManager.clearAll();
#else
        if(GameTextureManager.loadedPicture.Count > 1000)
            GameTextureManager.clearAll();
#endif
    }
    ...
    private void OnApplicationQuit()
    {
        ...
        for (var i = 0; i < servants.Count; i++) 
            servants[i].OnQuit();
        Running = false;
        try
        {
