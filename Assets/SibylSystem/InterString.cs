...
public static class InterString
{
    ...
    public static void initialize(string path)
    {
        ...
        GameStringHelper.kazu = Get("DECK");
        GameStringHelper.mudi = Get("GRAVE");
        GameStringHelper.chuwai = Get("REMOVED");
        GameStringHelper.ewai = Get("EXTRA");
        GameStringHelper.SemiNomi = Get("NotSummoned");
