...
public class GameField : OCGobject
{
    ...
    public List<gameHiddenButton> gameHiddenButtons = new List<gameHiddenButton>();
    ...
    public gameButton btn_confirm;
    public gameButton btn_cancel;
    public gameButton btn_decide;

    public GameObject cardsCount_left;
    public GameObject cardsCount_right;

    public GameField()
    {
        gameObject = create(Program.I().new_ocgcore_field, getGoodPosition(), Vector3.zero, false, null, false);
        ...
        gameHiddenButtons.Add(new gameHiddenButton(CardLocation.Deck, 0, new Vector3(0, -20, 0), new Vector3(6f, 1.5f, 8.6f)));
        gameHiddenButtons.Add(new gameHiddenButton(CardLocation.Extra, 0, new Vector3(0, 20, 0), new Vector3(6f, 1.5f, 8.6f)));
        gameHiddenButtons.Add(new gameHiddenButton(CardLocation.Grave, 0, Vector3.zero, new Vector3(5f, 3f, 5f)));
        gameHiddenButtons.Add(new gameHiddenButton(CardLocation.Removed, 0, Vector3.zero, new Vector3(4f, 3f, 4f)));
        gameHiddenButtons.Add(new gameHiddenButton(CardLocation.Deck, 1, new Vector3(0, -20, 0), new Vector3(6f, 1.5f, 8.6f)));
        gameHiddenButtons.Add(new gameHiddenButton(CardLocation.Extra, 1, new Vector3(0, 20, 0), new Vector3(6f, 1.5f, 8.6f)));
        gameHiddenButtons.Add(new gameHiddenButton(CardLocation.Grave, 1, Vector3.zero, new Vector3(5f, 3f, 5f)));
        gameHiddenButtons.Add(new gameHiddenButton(CardLocation.Removed, 1, Vector3.zero, new Vector3(4f, 3f, 4f)));
        ...
        btn_confirm = new gameButton(-2, "确认", superButtonType.yes);
        btn_cancel = new gameButton(-3, "取消", superButtonType.no);
        btn_decide = new gameButton(-4, "", superButtonType.decide);
        loadNewField();
    }

    public void ShowConfirmButton()
    {
        btn_confirm.show(new Vector3(Screen.width / 2 + 350 * Screen.height / 1080, Screen.height / 2 + 100 * Screen.height / 1080, 0));
    }

    public void ShowCancelButton(string hint)
    {
        btn_cancel.hint = hint;
        btn_cancel.show(new Vector3(Screen.width / 2 - 350 * Screen.height / 1080, Screen.height / 2 + 100 * Screen.height / 1080, 0));
    }

    public void hideSpButtons(GameObject go = null, bool hideDecideButton = true)
    {
        foreach(var btn in gameHiddenButtons)
        {
            btn.hideButton(go);
        }
        //if (hideDecideButton)
    ...
    public void relocatePnums(bool p)
    {
        if (Program.I().ocgcore.MasterRule >= 4)
        {
            ...
            //{
            //    me_left_p_num.transform.localScale = new Vector3(3, 3, 3);
            //    me_left_p_num.transform.eulerAngles = new Vector3(70, 0, 0);
            //    me_right_p_num.transform.localScale = new Vector3(3, 3, 3);
            //    me_right_p_num.transform.eulerAngles = new Vector3(70, 0, 0);
            //    op_left_p_num.transform.localScale = new Vector3(3, 3, 3);
            //    op_left_p_num.transform.eulerAngles = new Vector3(70, 0, 0);
            //    op_right_p_num.transform.localScale = new Vector3(3, 3, 3);
            //    op_right_p_num.transform.eulerAngles = new Vector3(70, 0, 0);
            //}
        ...
        else
        {
            ...
            {
                me_left_p_num.transform.localScale = new Vector3(3, 3, 3);
                me_left_p_num.transform.eulerAngles = new Vector3(45, -45, 0);
                me_right_p_num.transform.localScale = new Vector3(3, 3, 3);
                me_right_p_num.transform.eulerAngles = new Vector3(45, 45, 0);
                op_left_p_num.transform.localScale = new Vector3(3, 3, 3);
                op_left_p_num.transform.eulerAngles = new Vector3(45, -45, 0);
                op_right_p_num.transform.localScale = new Vector3(3, 3, 3);
                op_right_p_num.transform.eulerAngles = new Vector3(45, 45, 0);
            }
            else
            {
                me_left_p_num.transform.localScale = new Vector3(3, 3, 3);
    ...
    public void Update()
    {
        ...
        if (prereal != real)
        {
            ...
            else
            {
                if (p_hole_mel != null && p_hole_mer != null)
                {
                    p_hole_mel.localPosition = new Vector3(-33.5f, 5f, -11.6f);//new Vector3(-15.2f * real, 0, -9f);
                    p_hole_mer.localPosition = new Vector3(33.5f, 5f, -11.6f);//new Vector3(14.65f * real, 0, -9f);
                }

                if (p_hole_opl != null && p_hole_opr != null)
                {
                    p_hole_opl.localPosition = new Vector3(-33.5f, 5f, 14.5f);//new Vector3(-15.2f * real, 0, 9f);
                    p_hole_opr.localPosition = new Vector3(33.5f, 5f, 14.5f);//new Vector3(14.65f * real, 0, 9f);
                }
            }
        }
        ...
        if (Program.I().ocgcore.MasterRule >= 4)//mark 场地灵摆数字
        {
            ...
            //else
            //{
            //    me_left_p_num.transform.position = new Vector3(-17.2f, 1f, -18f);
            //    me_right_p_num.transform.position = new Vector3(17.2f, 1f, -18f);
            //    op_left_p_num.transform.position = new Vector3(-17.2f, 1f, 18f);
            //    op_right_p_num.transform.position = new Vector3(17.2f, 1f, 18f);
            //}
            me_left_p_num.transform.position = new Vector3(-17.2f, 1f, -18f);
            me_right_p_num.transform.position = new Vector3(17.2f, 1f, -18f);
            op_left_p_num.transform.position = new Vector3(-17.2f, 1f, 18f);
        ...
        else
        {
            if (P)
            {
                me_left_p_num.transform.position = new Vector3(-28.5f, 14.5f, -16f);
                me_right_p_num.transform.position = new Vector3(28.5f, 14.5f, -16f);
                op_left_p_num.transform.position = new Vector3(-28.5f, 14.5f, 7.5f);
                op_right_p_num.transform.position = new Vector3(28.5f, 14.5f, 7.5f);
            }
            else
            {
                me_left_p_num.transform.position = new Vector3(-30f, 11f, -15f);
                me_right_p_num.transform.position = new Vector3(30f, 11f, -15f);
                op_left_p_num.transform.position = new Vector3(-30f, 11f, 10f);
                op_right_p_num.transform.position = new Vector3(30f, 11f, 10f);
            }
        }
    }
    ...
    public void animation_show_big_string(Sprite sprite, bool only = false)
    {
        ...
        big_string = create(Program.I().New_phase, Program.I().ocgcore.centre(), Vector3.zero, false,
            Program.I().ui_windows_2d, true, Vector3.one * 1.5f);
        big_string.GetComponentInChildren<SpriteRenderer>().sprite = sprite;
        Program.I().ocgcore.Sleep(60);
