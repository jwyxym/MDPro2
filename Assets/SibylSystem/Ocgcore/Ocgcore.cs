...
public class Ocgcore : ServantWithCardDescription
{
                ...
                if (card != null)
                {
                    ...
                    if (Program.I().setting.setting.Voice.value)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if (!VoiceHandler.PlayCardLine(gps.controller, "activate", code, true, card.firstOnField, gps.location, chain))
                            ...
                            {
                                if (!VoiceHandler.PlayCardLine(gps.controller, "activateM", code, true, card.firstOnField, gps.location, chain))
                ...
                for (var i = 0; i < count; i++)
                {
                    ...
                    if (card != null)
                    {
                        ...
                        if (psum)
                        {
                            ...
                            targetTime = 220;
                            GameObject pendulum = ABLoader.LoadABFolder("timeline/summon/summonpendulum/summonpendulum01", "SummonAnimation");
                            ...
                            if(MasterRule >= 4)
                            {
                                ...
                                GameObject pendulumSet = ABLoader.LoadABFolder("timeline/summon/summonpendulum/summonpendulumscaleset", "PendulumSet");
                                ...
                                lScale.transform.localScale = new Vector3(1.2f, 1.2f, 1.2f);
                                rScale.transform.localScale = new Vector3(1.2f, 1.2f, 1.2f);
            ...
            case GameMessage.Attack:
                ...
                if (attackcard != null)
                {
                    if (Program.I().setting.setting.Voice.value)
                    {
                        ...
                        {
                            if(!VoiceHandler.PlayCardLine(p1.controller, "attack", cardId, true))
    ...
    public void StocMessage_TimeLimit(BinaryReader r)
    {
        ...
        Debug.Log("StocMessage_TimeLimit: " + player);
    ...
    public void onDuelResultConfirmed()
    {
        ...
        if (Program.I().room.needSide)
        {
            ...
            Program.I().deckManager.FromCodedDeckToObjectDeck();
